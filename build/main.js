// elm-watch hot {"version":"1.1.2","targetName":"My target name","webSocketPort":60279}
"use strict";
(() => {
...
var $author$project$Main$encodeAnswers = function () {
	var encodeAnswer = function (_v0) {
		var guess = _v0.guess;
		var correct = _v0.correct;
		var score = _v0.score;
	...
	return $elm$json$Json$Encode$list(encodeAnswer);
}();
...
var $author$project$Main$encodeCurrent = function (_v0) {
	var guess = _v0.guess;
	var correct = _v0.correct;
	return $elm$json$Json$Encode$object(
		_List_fromArray(
...
var $author$project$Main$encode = function (_v0) {
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'current',
				$author$project$Main$encodeCurrent(current))
			]));
};
...
var $author$project$Main$sumScore = A2(
	$elm$core$Basics$composeR,
	$elm$core$List$map(
		function ($) {
			return $.score;
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						'Din slutgiltliga poäng: ' + $author$project$Main$sumScore(answered))
					])),
				A2($author$project$Main$primary, $author$project$Main$Restart, 'Ny omgång')
			]));
};
